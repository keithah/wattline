...
final class SnapshotPolicyTests: XCTestCase {
    ...
    func testMaterialChangesAndNoise() {
        ...
        XCTAssertEqual(SnapshotMaterialChangePolicy.evaluate(previous: base, next: portStatus, lastWidgetReloadAt: t0, now: t0.addingTimeInterval(1)), SnapshotFanOutDecision(persist: true, updateActivity: true, reloadWidgets: false))
